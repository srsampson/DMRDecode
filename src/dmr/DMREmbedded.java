...
public class DMREmbedded {
    ...
    boolean QuadResidue1676(boolean[] word) {
        ...
        if (word[14] == true) {
            residueValue = residueValue + 2;
        }
        if (word[13] == true) {
            residueValue = residueValue + 4;
        }
        if (word[12] == true) {
            residueValue = residueValue + 8;
        }
        if (word[11] == true) {
            residueValue = residueValue + 16;
        }
        if (word[10] == true) {
            residueValue = residueValue + 32;
        }
        if (word[9] == true) {
            residueValue = residueValue + 64;
        }
        if (word[8] == true) {
            residueValue = residueValue + 128;
        }
        if (word[7] == true) {
            residueValue = residueValue + 256;
        }
        if (word[6] == true) {
            residueValue = residueValue + 512;
        }
        if (word[5] == true) {
            residueValue = residueValue + 1024;
        }
        if (word[4] == true) {
            residueValue = residueValue + 2048;
        }
        if (word[3] == true) {
            residueValue = residueValue + 4096;
        }
        if (word[2] == true) {
            residueValue = residueValue + 8192;
        }
        if (word[1] == true) {
            residueValue = residueValue + 16384;
        }
        if (word[0] == true) {
            residueValue = residueValue + 32768;
        }
        // Run through the possible values and we have a match return true
        for (a = 0; a < 128; a++) {
            if (residueValue == ResidueNums[a]) {
                return true;
            }
        }
