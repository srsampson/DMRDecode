...
public class UsersLogged {
    ...
    public void setChannel(int tident, int channel) {
        if (channel == 1) {
            usedChannel1[tident] = true;
        } else {
            usedChannel2[tident] = true;
        }
    }
    ...
    public String returnInfo(int index) {
        ...
        // Channels
        if ((usedChannel1[index] == true) && (usedChannel2[index] == false)) {
            l = l + " (Only used channel 1)";
        } else if ((usedChannel2[index] == true) && (usedChannel1[index] == false)) {
            l = l + " (Only used channel 2)";
        } else if ((usedChannel1[index] == true) && (usedChannel2[index] == true)) {
            l = l + " (Used both channels)";
        }
        // All done
        return l;
    }
