...
public class Utilities {
    ...
    public String returnMFIDName(int mfid) {
        if (mfid == 0x04) {
            ...
            return "Trident Datacom";
        } else if (mfid == 0x07) {
            return "RADIODATA";
        } else if ((mfid == 0x08) || (mfid == 0x68)) {
            return "HYT";
        } else if (mfid == 0x10) {
            return "Motorola";
        } else if ((mfid == 0x13) || (mfid == 0x1c)) {
            return "EMC SPA";
        } else if ((mfid == 0x33) || (mfid == 0x3c)) {
            return "Radio Activity Srl";
        } else if (mfid == 0x58) {
            return "Tait";
        } else if (mfid == 0x77) {
    ...
    public int retSixteen(boolean bits[], int offset) {
        ...
        if (bits[offset + 1] == true) {
            b = b + 16384;
        }
        if (bits[offset + 2] == true) {
            b = b + 8192;
        }
        if (bits[offset + 3] == true) {
            b = b + 4096;
        }
        if (bits[offset + 4] == true) {
            b = b + 2048;
        }
        if (bits[offset + 5] == true) {
            b = b + 1024;
        }
        if (bits[offset + 6] == true) {
            b = b + 512;
        }
        if (bits[offset + 7] == true) {
            b = b + 256;
        }
        if (bits[offset + 8] == true) {
            b = b + 128;
        }
        if (bits[offset + 9] == true) {
            b = b + 64;
        }
        if (bits[offset + 10] == true) {
            b = b + 32;
        }
        if (bits[offset + 11] == true) {
            b = b + 16;
        }
        if (bits[offset + 12] == true) {
            b = b + 8;
        }
        if (bits[offset + 13] == true) {
            b = b + 4;
        }
        if (bits[offset + 14] == true) {
            b = b + 2;
        }
        if (bits[offset + 15] == true) {
            b++;
        }
        return b;
    }
    ...
    public String decodeServiceOptions(boolean bits[], int offset) {
        ...
        // Emergency
        if (bits[offset] == false) {
            so.append("Non-emergency");
        } else {
            so.append("Emergency");
        }
        // Privacy
        if (bits[offset + 1] == true) {
            so.append("/Privacy Enabled");
        }
