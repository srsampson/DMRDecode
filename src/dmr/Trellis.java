...
public class Trellis {
    ...
    private byte[] extractDibits(boolean[] rawBits) {
        ...
        for (a = 0; a < 196; a = a + 2) {
            ...
            // 10 = -1
            // 11 = -3
            if ((rawBits[a] == false) && (rawBits[a + 1] == true)) {
                trellisDibit = +3;
            } else if ((rawBits[a] == false) && (rawBits[a + 1] == false)) {
                trellisDibit = +1;
            } else if ((rawBits[a] == true) && (rawBits[a + 1] == false)) {
                trellisDibit = -1;
            } else if ((rawBits[a] == true) && (rawBits[a + 1] == true)) {
                trellisDibit = -3;
            }
            // Deinterleave
    ...
    private byte[] constellationOut(byte[] encDibit) {
        ...
        int a, index = 0;
        for (a = 0; a < 98; a = a + 2) {
            if ((encDibit[a] == +1) && (encDibit[a + 1] == -1)) {
                constellationPoints[index] = 0;
            } else if ((encDibit[a] == -1) && (encDibit[a + 1] == -1)) {
                constellationPoints[index] = 1;
            } else if ((encDibit[a] == +3) && (encDibit[a + 1] == -3)) {
                constellationPoints[index] = 2;
            } else if ((encDibit[a] == -3) && (encDibit[a + 1] == -3)) {
                constellationPoints[index] = 3;
            } else if ((encDibit[a] == -3) && (encDibit[a + 1] == -1)) {
                constellationPoints[index] = 4;
            } else if ((encDibit[a] == +3) && (encDibit[a + 1] == -1)) {
                constellationPoints[index] = 5;
            } else if ((encDibit[a] == -1) && (encDibit[a + 1] == -3)) {
                constellationPoints[index] = 6;
            } else if ((encDibit[a] == +1) && (encDibit[a + 1] == -3)) {
                constellationPoints[index] = 7;
            } else if ((encDibit[a] == -3) && (encDibit[a + 1] == +3)) {
                constellationPoints[index] = 8;
            } else if ((encDibit[a] == +3) && (encDibit[a + 1] == +3)) {
                constellationPoints[index] = 9;
            } else if ((encDibit[a] == -1) && (encDibit[a + 1] == +1)) {
                constellationPoints[index] = 10;
            } else if ((encDibit[a] == +1) && (encDibit[a + 1] == +1)) {
                constellationPoints[index] = 11;
            } else if ((encDibit[a] == +1) && (encDibit[a + 1] == +3)) {
                constellationPoints[index] = 12;
            } else if ((encDibit[a] == -1) && (encDibit[a + 1] == +3)) {
                constellationPoints[index] = 13;
            } else if ((encDibit[a] == +3) && (encDibit[a + 1] == +1)) {
                constellationPoints[index] = 14;
            } else if ((encDibit[a] == -3) && (encDibit[a + 1] == +1)) {
                constellationPoints[index] = 15;
            }
            index++;
        }
